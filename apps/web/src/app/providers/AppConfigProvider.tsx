    ...
    try {
      ...
      if (cached) {
        ...
        return {
          ...
          ONPATIENT_SECRET_CONFIGURED: doc.ONPATIENT_SECRET_CONFIGURED,
          ATHENA_CLIENT_ID: doc.ATHENA_CLIENT_ID,
          ATHENA_SANDBOX_CLIENT_ID: doc.ATHENA_SANDBOX_CLIENT_ID,
          NEXTGEN_CLIENT_ID: doc.NEXTGEN_CLIENT_ID,
          NEXTGEN_SECRET_CONFIGURED: doc.NEXTGEN_SECRET_CONFIGURED,
