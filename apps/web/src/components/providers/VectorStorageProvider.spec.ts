...
describe('VectorStorageProvider', () => {
  describe('prepareClinicalDocumentForVectorization', () => {
    it('can serialize a DiagnosticReport correctly', async () => {
      const result =
        await prepareClinicalDocumentForVectorization(testClinicalDocument);
