...
import { checkIfXmlIsCCDA } from '../../timeline/components/document-reference/ShowDocumentReferenceAttachmentExpandable';
import { parseCCDARaw } from '../../timeline/components/document-reference/parseCCDA/parseCCDA';
