...
<table>
  ...
  <tr>
    ...
    <td>   Yes - when you take certain steps while self-hosting (<a target='_blank' href='https://meremedical.co/docs/getting-started/docker#setting-up-with-docker-compose--local-ssl-with-caddy'>click to learn how</a>)</td>
  </tr>
</table>
<p>
  </p>
